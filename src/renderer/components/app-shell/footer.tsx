...
export function Footer({ left, center, right }: FooterProps) {
  return (
    <footer className="flex flex-shrink-0 items-center justify-between border-t border-line bg-surface-1 px-7 py-3.5">
      ...
      <div className="flex items-center text-body-sm text-fg-secondary">{center}</div>
