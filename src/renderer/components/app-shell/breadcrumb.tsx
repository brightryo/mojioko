    ...
    >
      <div className="max-w-[1100px] mx-auto w-full flex items-center px-6">
        ...
        <div className="flex items-center gap-2 mr-5 flex-shrink-0">
          <span className="text-[13px] font-semibold text-zinc-300 select-none">{APP_NAME}</span>
            ...
            return (
              <div key={config.step} className="flex items-center gap-1">
                ...
                <button
                  ...
                  className={cn(
                    'flex items-center gap-1.5 rounded-md px-3 py-1.5 text-[14px] transition-colors duration-150',
  ...
  return (
    <div className="relative flex-shrink-0">
      <button
        ...
        className="flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-[13px] text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800/60 transition-colors duration-150"
      >
        {current.label}
          ...
          <div className="absolute right-0 top-full mt-1 w-28 rounded-lg border border-zinc-800 bg-zinc-900 shadow-xl z-50 py-1 overflow-hidden">
            {options.map((opt) => (
              <button
                ...
                className={cn(
                  'w-full px-3 py-2 text-left text-[13px] transition-colors duration-150',
                  language === opt.value
