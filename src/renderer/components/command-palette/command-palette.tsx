        ...
        >
          <div className="flex items-center border-b border-zinc-800 px-3">
            <Command.Input
              ...
              className="flex h-11 w-full bg-transparent text-body text-zinc-100 placeholder:text-zinc-600 focus:outline-none"
              autoFocus
            />
          </div>
          <Command.List className="max-h-[360px] overflow-y-auto py-2">
            ...
            <Command.Empty className="py-8 text-center text-body text-zinc-300">
              {t('group.navigation')}
            </Command.Empty>
              ...
              <Command.Group key={group} heading={label}>
                {items.map((cmd) => (
                  <Command.Item
                    ...
                    className="flex cursor-default items-center justify-between rounded-md mx-1 px-3 py-2 text-body text-zinc-300 aria-selected:bg-zinc-800 aria-selected:text-zinc-50 transition-colors duration-100"
                  >
